                ...
                <div class="col-xl-8 col-lg-12 col-md-9">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h1 class="h3 mt-2 mb-2 text-gray-800">Supplier Baru</h1>
                        </div>
                        <div class="card-body">
                            <form action="/supplier/store" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_sup" name="nama_sup" placeholder="Nama">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="alamat_sup">Alamat Supplier</label>
                                    <input type="text" class="form-control" id="alamat_sup" name="alamat_sup" placeholder="Alamat">
                                </div>
                                <div class="form-group mb-3">
